...
class ProdMongoModel {
     ...
     * @returns {Promise<Object>} Un objeto con un mensaje y los detalles del producto si existe.
     ...
     * @returns {Promise<Object>} Un mensaje con la confirmación de que el producto fue agregado.
     */
    postProd = async (data) => {
     ...
     * @returns {Promise<Object>} Un mensaje con la confirmación de que el producto fue actualizado.
     ...
     * @returns {Promise<Object>} Un mensaje con la confirmación de que el producto fue reemplazado.
     */
     ...
     * @returns {Promise<Object>} Un mensaje con la confirmación de que el producto fue eliminado.
